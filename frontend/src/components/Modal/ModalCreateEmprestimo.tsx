...
const ModalEmprestimo = ({
  ...
  const adicionarUmaSemana = () => {
    const dataBase = data_devolucao_esperada
      ? new Date(data_devolucao_esperada)
      : new Date();
      ...
      <div className="bg-white rounded-2xl shadow-xl w-[90%] max-w-sm max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-t">
          <button
            ...
            className="w-full bg-[#133E87] text-white py-2 rounded font-semibold hover:bg-[#0f326f] transition"
          >
            Adicionar Empréstimo
          </button>
        </div>
